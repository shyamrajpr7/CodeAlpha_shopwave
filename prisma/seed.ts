...
const products = [
  ...
  { name: 'Wireless Earbuds Sport', slug: 'wireless-earbuds-sport', description: 'Secure-fit sport earbuds with ear hooks, IP68 rating and 10-hour playtime.', price: 59.99, originalPrice: null, category: 'Wearables', image: 'https://images.unsplash.com/photo-1610438235354-a6ae5528385c?w=600&q=80', badge: null, rating: 4.5, reviews: 789, stock: 40, features: JSON.stringify(['Ear hook design', 'IP68 rating', '10-hour playtime', 'Wireless charging', 'Sweat proof']), color: '#ec4899' },
  ...
  { name: 'Gaming Mousepad XL', slug: 'gaming-mousepad-xl', description: 'Extended RGB gaming mousepad with 11 lighting modes and cable management.', price: 29.99, originalPrice: 39.99, category: 'Gaming', image: 'https://images.unsplash.com/photo-1563297007-0686b7003af7?w=600&q=80', badge: 'Sale', rating: 4.5, reviews: 2345, stock: 40, features: JSON.stringify(['900x400mm', '11 RGB modes', 'Cable management', 'Water resistant', 'Speed surface']), color: '#a855f7' },
