...
const products = [
  ...
  { name: 'Wireless Soundbar', slug: 'wireless-soundbar', description: 'Dolby Atmos soundbar with wireless subwoofer and HDMI eARC for immersive home theater.', price: 349.99, originalPrice: 449.99, category: 'Audio', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&q=80', badge: 'Sale', rating: 4.6, reviews: 321, stock: 8, features: JSON.stringify(['Dolby Atmos', 'Wireless subwoofer', 'HDMI eARC', 'Bluetooth 5.2', 'Voice assistant']), color: '#ec4899' },
  ...
  { name: 'Monitor Light Bar', slug: 'monitor-light-bar', description: 'Asymmetric LED light bar with auto-dimming, ambient sensor and USB hub.', price: 49.99, originalPrice: 69.99, category: 'Displays', image: 'https://images.unsplash.com/photo-1507473885765-e6ed057ab6fe?w=600&q=80', badge: 'Popular', rating: 4.6, reviews: 2345, stock: 55, features: JSON.stringify(['Asymmetric light', 'Auto-dimming', 'Ambient sensor', 'USB hub', 'Memory function']), color: '#f59e0b' },
  ...
  { name: 'Desk Cable Management', slug: 'desk-cable-management', description: 'Under-desk cable tray with adhesive mount and 10 velcro cable ties included.', price: 14.99, originalPrice: 24.99, category: 'Accessories', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&q=80', badge: 'Sale', rating: 4.3, reviews: 4567, stock: 120, features: JSON.stringify(['Under-desk tray', 'Adhesive mount', '10 velcro ties', 'Steel mesh', 'Easy install']), color: '#14b8a6' },
  ...
  { name: 'USB-C Cable 2m', slug: 'usb-c-cable-2m', description: 'Braided nylon USB-C to USB-C cable with 100W PD and 480Mbps data transfer.', price: 12.99, originalPrice: null, category: 'Accessories', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&q=80', badge: null, rating: 4.7, reviews: 6789, stock: 200, features: JSON.stringify(['100W Power Delivery', '480Mbps data', 'Braided nylon', '2m length', 'Aluminum connectors']), color: '#06b6d4' },
  ...
  { name: 'LED Strip Lights 5m', slug: 'led-strip-lights-5m', description: '5-meter RGB LED strip with app control, music sync and 16 million colors.', price: 29.99, originalPrice: 39.99, category: 'Lighting', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&q=80', badge: 'Popular', rating: 4.4, reviews: 3456, stock: 45, features: JSON.stringify(['5m length', '16M colors', 'Music sync', 'App control', 'Self-adhesive']), color: '#8b5cf6' },
  { name: 'Desk Lamp Foldable', slug: 'desk-lamp-foldable', description: 'Minimalist foldable desk lamp with 3 brightness levels and 5000K daylight color.', price: 24.99, originalPrice: null, category: 'Lighting', image: 'https://images.unsplash.com/photo-1507473885765-e6ed057ab6fe?w=600&q=80', badge: null, rating: 4.3, reviews: 1234, stock: 50, features: JSON.stringify(['3 brightness levels', '5000K daylight', 'Foldable design', 'USB powered', 'Touch control']), color: '#f59e0b' },
  ...
  { name: 'Wireless Earbuds Sport', slug: 'wireless-earbuds-sport', description: 'Secure-fit sport earbuds with ear hooks, IP68 rating and 10-hour playtime.', price: 59.99, originalPrice: null, category: 'Wearables', image: 'https://images.unsplash.com/photo-1590658268037-6bf12f032f55?w=600&q=80', badge: null, rating: 4.5, reviews: 789, stock: 40, features: JSON.stringify(['Ear hook design', 'IP68 rating', '10-hour playtime', 'Wireless charging', 'Sweat proof']), color: '#ec4899' },
  ...
  { name: 'Gaming Mousepad XL', slug: 'gaming-mousepad-xl', description: 'Extended RGB gaming mousepad with 11 lighting modes and cable management.', price: 29.99, originalPrice: 39.99, category: 'Gaming', image: 'https://images.unsplash.com/photo-1616353071857-0230a9c02356?w=600&q=80', badge: 'Sale', rating: 4.5, reviews: 2345, stock: 40, features: JSON.stringify(['900x400mm', '11 RGB modes', 'Cable management', 'Water resistant', 'Speed surface']), color: '#a855f7' },
